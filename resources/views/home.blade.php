...
<head>
    ...
    <!-- Favicon -->
    <link href="img/favinearcon.ico" rel="icon">
...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("public/img/1.png");
  height: 50%;
...
<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
    <a href="/" class="navbar-brand d-flex align-items-center  px-4 px-lg-5">
        ...
        <img src="public/img/neargylogo.png" class="m-0 text-primary" width="27%">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <a href="/" class="nav-item nav-link {{ Request::is('/') ? 'active' : '' }}">{{__('messages.home')}}</a>
    <a href="about" class="nav-item nav-link {{ Request::is('about*') ? 'active' : '' }}">{{__('messages.about')}}</a>
    <a href="service" class="nav-item nav-link {{ Request::is('service*') ? 'active' : '' }}">{{__('messages.service')}}</a>
    <a href="project" class="nav-item nav-link {{ Request::is('project*') ? 'active' : '' }}">{{__('messages.project')}}</a>
    <a href="contact" class="nav-item nav-link {{ Request::is('contact*') ? 'active' : '' }}">{{__('messages.contact')}}</a>
...
<div class="hero-image">
 ...
 <center>
    <br>
    <br>
 <h3 style="color:white;" >Compare and save on clean<br>
     home energy solutions</h3>
     
     <h6 style="color:white;" >Research and shop through our network <br>
     of pre-screened, local installers</h6>
...
<!-- Hero Section -->
<!-- <section class="flex items-center justify-center h-screen bg-cover bg-center relative" style="background-image: url('path_to_solar_panels_image.jpg');">
    <div class="absolute top-0 left-0 w-full h-full bg-gray-800 opacity-50"></div>
    <div class="z-10 text-white text-center p-5">
        <h1 class="text-4xl font-bold mb-3">Acelerando la Creación de Comunidades Energéticas</h1>
        <p class="mb-50 mb-lg-100">">Conectando personas con Comunidades Energéticas cercanas para una vida más sostenible.</p>
        <a href="#learn-more" class="btn-learn-more">Aprende más</a>
    </div>
</section> -->
